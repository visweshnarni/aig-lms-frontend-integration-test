...
// Replace this with your real context/hook for production use
...
export default function VideoPlayerPage() {
  ...
  // Find event
  console.log("Loaded videoID:", videoID, "eventId from URL:", id);
console.log("videos list:", videos);
  ...
  // All videos from this event, filter for this session
...
//         <div className="mb-4 text-lg text-red-600">You need to register to access this video.</div>
//         <button onClick={() => setShowModal(true)} className="bg-green-700 text-white px-4 py-2 rounded-md">
//           Register to Watch
//         </button>
//         <RegisterModal isOpen={showModal} onClose={() => setShowModal(false)} eventTitle={event?.title ?? ""} onRegister={() => { register(id); setShowModal(false); }} />
//       </div>
//     );
//   }
  ...
  return (
    <div className="p-6 flex flex-col lg:flex-row gap-8">
      ...
      <div className="flex-1">
        ...
        <h2 className="mt-4 text-2xl font-semibold text-gray-800">{video.title}</h2>
