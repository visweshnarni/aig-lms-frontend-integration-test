...
export function SignupForm() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#f0faff]">
      {/* Left: Signup Form */}
      <div className="flex w-full md:w-1/2 justify-center items-center p-6">
        ...
        >
          ...
          {/* Prefix */}
          <div>
            <label htmlFor="prefix" className="mb-1 font-semibold text-gray-700">
          ...
          {/* Mobile */}
          <div>
            <label htmlFor="mobile" className="mb-1 font-semibold text-gray-700">
          ...
          <Button
            type="submit"
            className="w-full font-medium bg-orange-500 hover:bg-[#0d47a1] text-white mt-1"
          >
            Sign Up
          </Button>
